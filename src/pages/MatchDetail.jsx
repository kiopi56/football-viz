 ...
 * - Claude API（claude-haiku-4-5）でナラティブを生成（Supabase Edge Function 経由）
...
## 今季（${season}-${String(season + 1).slice(-2)}）の時間帯別データ（シーズン累積）
${byTimeStr}

## 過去3シーズンの得失点推移（時間帯別含む）
${historySections}

以下の2つの観点で、それぞれ3〜4文で分析してください：
1. 今季トレンドとの照合（時間帯別データを活用）
2. 過去3シーズンとの比較（後半失点の傾向変化など）
            ...
            <div style={{ background: "#0e1318", border: "1px solid rgba(255,255,255,0.08)",
              ...
              <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 14 }}>
                <div>
                  ...
                  <div style={{ fontSize: 9, color: "#333", marginTop: 2 }}>claude-haiku-4-5</div>
                </div>
                <button
